...
public class Funcionario implements Serializable {
	...
	@Lob
	private byte[] foto;
	@NotEmpty(message="O nome de usuario deve ser informado")
	@Length(max=20,message="O nome de usuario nao pode ultrapassar {max} caracteres")
	...
	@Length(max=20,message="A senha nao pode ultrapassar {max} caracteres")
